 ...
 * Plugin URI: https://github.com/thienphuoc1990/itvndocorg-wp-image-slider
...
?>
<?php
if (!class_exists('Itvndocorg_WP_Image_Slider')) {
	/**
	* 
	*/
	class Itvndocorg_WP_Image_Slider
	{
	...
	function iwis_load(){
		global $iwis;
		$iwis = new Itvndocorg_WP_Image_Slider();
