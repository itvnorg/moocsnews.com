...
$courses = get_post_by_taxonomy('course', 'post_tag', $term->slug, -1);
...
<section class="main-content">
	<div class="container">
		<!-- BEGIN: Breadcrumb -->
		<div class="row">
			<div class="col-md-12"><h1 class="page-title">Showing course for "<?php echo $current_tag; ?>"</span></h1> <!-- Page Title --></div>
		</div>
		<!-- END: Breadcrumb -->
