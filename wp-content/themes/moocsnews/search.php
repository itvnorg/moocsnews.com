...
$search_term = get_query_var( 's', null );
...
<section class="main-content">
	<div class="container">
		<div class="row">
			<div class="col-md-12"><h1 class="page-title">Search results for "<?php echo $search_term; ?>"</span></h1> <!-- Page Title --></div>
		</div>
				...
				<div class="left-filter">
					<h3>
						...
						<strong class="text-bold">
							<span class="text--bold" id="number-of-courses"><?php echo $courses->post_count; ?></span> 
							courses
						</strong>
					</h3>
